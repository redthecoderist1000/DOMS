            ...
            <div class="form-container">
                ...
                <div class="student-violation">
                        ...
                        <div class="table-nav">
                            <div class="nav-list">
                                ...
                                <ul style="margin-top: .5rem;">
                                    <input type="submit" name="counseling" value="COUNSELING">
                                    </input>
                                    <input type="submit" name="community" value="COMMUNITY SERVICE" style="border-bottom: solid 3px rgb(98, 130, 172)">
                                    </input>
                                </ul>
                            </div>
                        </div>
                    ...
                    <form action="php/insert_violation_major.php" method="POST">
                        ...
                        <input type="hidden" name="offense_type" value="<?php echo $offense_type; ?>">
                        <input type="hidden" name="description" value="<?php echo $description; ?>">
                        <input type="hidden" name="intervention_type" value="Community">
                        ...
                        <div class="violation-container1">
                            <div class="multi-left">
                                ...
                                <div class="input-wrap">
                                    <label for="department" style="min-width: 200px;">Specify Department:</label>
