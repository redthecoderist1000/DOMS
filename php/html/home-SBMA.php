    ...
    <section class="main-do">
        ...
        <div class="body-content">
            ...
            <div class="body-nav">
                ...
                <a href="home-SASE.php"><span>SASE</span></a>
                <a href="#" style="background-color: var(--div-primary-color); color: white;"><span>SBMA</span></a>
                ...
                <div class="department-info">
                    ...
                    <div class="dept dept2">
                        ...
                        <div class="dept-info dept-info2">
                            <p>Hospitality Management Dept.</p>
                        </div>
                    ...
                    <div class="dept dept3">
                        ...
                        <div class="dept-info dept-info3">
                            <p>Business Administration Dept.</p>
                        </div>

                        <p>28%</p>
                    </div>

                    <div class="dept dept4">
                        <div class="color color4"></div>

                        <div class="dept-info dept-info4">
                            <p>Accountancy Dept.</p>
                        </div>

                        <p>40%</p>
                    </div>

                    <div class="dept dept5">
                        <div class="color color5"></div>

                        <div class="dept-info dept-info5">
                            <p>Management Accounting Dept.</p>
                        </div>
